...
os.makedirs("/run/media/theodoros/E/projects/dataflow__analyizer/depi_project/notebooks", exist_ok=True)
notebook_path = "/run/media/theodoros/E/projects/dataflow__analyizer/depi_project/notebooks/sentinel2_land_cover_classification.ipynb"
